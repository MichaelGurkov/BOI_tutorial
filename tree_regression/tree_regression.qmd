---
title: "Introduction to Tree Regression with [Boston](../datasets/boston.qmd) data"
format: html
execute: 
  cache: true
---
...
We split the data into training and testing sets. The `initial_split` function ensures that the proportion of `medv` is maintained in both sets.
